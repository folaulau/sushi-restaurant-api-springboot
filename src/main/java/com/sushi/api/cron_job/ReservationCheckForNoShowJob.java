...
@Component
@Slf4j
public class ReservationCheckForNoShowJob {
  ...
  public void checkForNoShowReservation() {
    log.info("checkForNoShowReservation {}", LocalDateTime.now());
    ...
    while (true) {
      ...
      reservations.stream().forEach(reservation -> {
        ...
        reservation = reservationService.markAsNoShow(reservation);
